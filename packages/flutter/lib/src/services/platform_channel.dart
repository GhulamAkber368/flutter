...
final Expando<BinaryMessenger> _debugBinaryMessengers =
...
final Map<String, _PlatformChannelStats> _debugProfilePlatformChannelsStats =
...
class MethodChannel {
  ...
  Future<T?> _invokeMethod<T>(String method,
    ...
    final ByteData? result = !kReleaseMode && debugProfilePlatformChannels
